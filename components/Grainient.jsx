...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    const setSize = () => {
      // Use layout box (clientWidth/Height), NOT getBoundingClientRect: the
      // latter includes ancestor CSS transforms (tablet tilt/scale), which
      // mis-sizes the canvas and leaves the container partially uncovered.
