...
function PixelSwap({
  ...
  // Declared before every other effect on purpose: effects run in declaration
  // order, so the snapshots are already fresh by the time the transition
  // effects below read them. Writing them during render trips react-hooks/refs.
  useEffect(() => {
