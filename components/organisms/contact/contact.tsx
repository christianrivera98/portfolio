...
import { CONTACT_LINKS, CONTACT_SECTION } from "./contact.config"
...
export function Contact() {
  ...
  return (
    ...
    >
      <ParticlesBackground />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full bg-[hsl(356,96%,22%)] opacity-[0.03] blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 md:px-16">
        ...
        <div className="contact-links">
          {CONTACT_LINKS.map((link, i) => (
            <ContactLinkRow key={link.id} link={link} isFirst={i === 0} />
          ))}
        </div>
      </div>
    </section>
